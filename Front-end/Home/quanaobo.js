document.addEventListener("DOMContentLoaded", function () {
  ...
  function createNewProducts() {
    ...
    const products = [
      ...
      {
        img: "ảnh/b3.jpg",
        name: "Bộ hè Hydro Áo xanh nõn chuối chấm bi",
        price: 739000,
        rating: "★★★★★",
      },
      {
        img: "ảnh/b4.jpg",
        name: "Bộ hè Hydro đen tia sét trắng quần dằn di chấm bi",
        price: 729000,
        rating: "★★★★★",
      },
      {
        img: "ảnh/b5.jpg",
        name: "Bộ hè Essen nâu 2 dòng chữ MS:2301",
        price: 850000,
        rating: "★★★★★",
      },
    ];
