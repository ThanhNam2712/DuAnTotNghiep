document.addEventListener("DOMContentLoaded", function () {
  ...
  function createNewProducts() {
    ...
    const products = [
      {
        img: "ảnh/s4.jpg",
        name: "Áo sơ mi Dior dài tay trắng",
        price: 1500000,
        rating: "★★★★★",
      },
      {
        img: "ảnh/s5.jpg",
        name: "Áo sơ mi trắng kẻ ở cổ tay",
        price: 990000,
        rating: "★★★★★",
      },
      {
        img: "ảnh/s6.jpg",
        name: "Áo sơ mi BBR dài tay",
        price: 1990000,
        rating: "★★★★★",
      },
      {
        img: "ảnh/s7.jpg",
        name: "Áo sơ mi đen GC vải lụa",
        price: 1750000,
        rating: "★★★★★",
      },
      {
        img: "ảnh/s8.jpg",
        name: "Áo sơ mi VerSace vải lụa",
        price: 1090000,
        rating: "★★★★★",
      },
    ];
